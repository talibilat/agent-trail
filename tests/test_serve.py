...
class ServeTests(unittest.TestCase):
    ...
    def test_http_server_serves_offline_shell_and_versioned_api(self):
        ...
        self.assertIn('data-action="pan-left"', html)
        self.assertIn('data-action="pan-right"', html)
        self.assertIn('data-action="pan-up"', html)
        self.assertIn('data-action="pan-down"', html)
