...
A supplied command that is malformed or blank is reported as invalid tool command evidence and keeps coverage incomplete, while an absent command remains valid optional metadata when a substantive result is available.
