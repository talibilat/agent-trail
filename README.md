...
Resolved start events ordered after their finished event remain visible but are reported as verification lifecycle contradictions and keep coverage incomplete; sequence establishes start/finish order for events from the same emitter despite equal or skewed timestamps, while timestamps establish order across emitters and equal timestamps remain non-contradictory.
