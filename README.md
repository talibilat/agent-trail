...
Coverage is `complete` only when all five core categories are present, every direct, compacted, or verification-lifecycle reference resolves to valid evidence, every verification is known to predate the change, and every verification passed.
